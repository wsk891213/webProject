...
public class LoginController {
	...
	* 
	* 존재하는 ID 여부체크
	* @methodName : checkIDifExist
	* @author : WooSin Kim
	* @date : 2020.12.06 
	* @return 
	*/
	@RequestMapping(value = "/checkIDifExist", method = RequestMethod.POST)
	@ResponseBody
	public String checkIDifExist(@ModelAttribute UserVO userVO) {
		// 로그인 체크
		if (loginService.checkIDifExist(userVO)) {
			return "true";
		} else {
			return "false";
		}
